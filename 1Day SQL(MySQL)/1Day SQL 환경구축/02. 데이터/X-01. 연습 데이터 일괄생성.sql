...
DELETE FROM TB_CUSTOMER WHERE CUSTOMER_CD > '';
...
DELETE FROM TB_ADD_CUSTOMER WHERE CUSTOMER_CD > '';
...
DELETE FROM TB_POINT WHERE CUSTOMER_CD > '';
...
DELETE FROM TB_ETC_INFO WHERE CUSTOMER_CD > '';
...
DELETE FROM TB_ITEM_INFO WHERE ITEM_CD > '';
...
DELETE FROM TB_GRADE WHERE CLASS_CD > '';
...
DELETE FROM TB_GRADE_07 WHERE TEST_CD > '';
...
DELETE FROM TB_GRADE_08 WHERE TEST_CD > '';
...
DELETE FROM TB_GRADE_09 WHERE TEST_CD > '';
...
DELETE FROM TB_CLASS_INFO WHERE CLASS_CD > '';
...
DELETE FROM TB_SALES WHERE SALES_DT > '';
...
DELETE FROM TB_TRAIN_TM WHERE TRAIN_NO > '';
